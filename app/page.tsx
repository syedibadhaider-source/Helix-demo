        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-[minmax(280px,auto)]">
                ...
                <ul className="mosaic-list flex-1 flex flex-col justify-end space-y-8">
                  <li className="!block !mb-0 w-full group/item">
                    <div className="flex items-center justify-start gap-4 w-full mb-1">
                      ...
                      <div className="flex flex-col text-left">
                        <strong className="!text-3xl lg:!text-4xl text-red leading-none mb-1 group-hover/item:translate-x-1 transition-transform origin-left inline-block">Integrity</strong>
                  ...
                  <li className="!block !mb-0 w-full group/item">
                    <div className="flex items-center justify-start gap-4 w-full mb-1">
                      ...
                      <div className="flex flex-col text-left">
                        <strong className="!text-3xl lg:!text-4xl text-red leading-none mb-1 group-hover/item:translate-x-1 transition-transform origin-left inline-block">Honesty</strong>
                  ...
                  <li className="!block !mb-0 w-full group/item">
                    <div className="flex items-center justify-start gap-4 w-full mb-1">
                      ...
                      <div className="flex flex-col text-left">
                        <strong className="!text-3xl lg:!text-4xl text-red leading-none mb-1 group-hover/item:translate-x-1 transition-transform origin-left inline-block">Pride</strong>
            ...
            <article className="mosaic-card mosaic-card-support col-span-1 lg:col-span-1 shadow-sm transition-transform hover:-translate-y-1 flex flex-col justify-center min-h-[280px] !p-8">
              ...
              <div className="mosaic-support-notes !mt-0 gap-3 !justify-start !ml-0 w-full flex-wrap">
